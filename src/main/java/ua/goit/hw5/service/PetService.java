...
public class PetService {
    ...
    public Pet getPet(View view) {
        ...
        do {
            try {
                ...
                view.write("How many tags do you want to add pet?");
                ...
                pet.setTags(tags);
                view.write("Enter status of the pet -> available, pending, sold");
                ...
                isMistakeInOrder = true;
                view.write("Illegal pet status. Please try again");
            }
    ...
    public List<Pet> findPetByStatus(PetStatus status) {
    ...
    public ApiResponse updatePetByFormData(Long petId, String petName, PetStatus status) {
        String url = "/pet/" + petId;
