...
import ua.goit.hw5.exceptions.OrderNotFoundException;
    ...
    public Order getOrder(View view) {
        ...
        do {
            try {
                ...
                order.setId(Long.valueOf(view.read()));
                ...
                view.write("Is order complete? Choose yes or not");
                order.setComplete(view.read().equals("yes"));
            } catch (DateTimeException ex) {
                view.write("The date is in an illegal format");
                isMistakeInOrder = true;
            } catch (NumberFormatException ex) {
                view.write("PetId or quantity is in illegal format");
                isMistakeInOrder = true;
